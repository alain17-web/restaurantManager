...
import NewOrder from "../../../components/restaurantComponent/newOrder/NewOrder.tsx";
                            ...
                            {username === "guest" &&
                                <>
                                    <div className={"flex items-center mr-5 pr-1 relative"}>
                                        <img src={"./img/dashboard.svg"} width={20} height={20}/>
                                        <Link to={'/dashboard'}
                                              className={'text-[#555] decoration-0 cursor-pointer pl-1'}>Tableaux </Link>
                                    </div>
                                    <div className={"flex items-center mr-5 pr-1 relative"}>
                                        <img src={"./img/chef.svg"} width={20} height={20}/>
                                        <Link to={'/kitchen'}
                                              className={'text-[#555] decoration-0 cursor-pointer pl-1'}>Cuisine</Link>
                                    </div>
                                </>
                            }
