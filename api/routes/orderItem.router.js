...
orderItemRouter.route("/")
    .get(authenticate,authorize([9,10]),orderItemController.getFirstUnvalidatedOrderItems)

orderItemRouter.route("/:order_id")
    .get(authenticate, authorize([1,10]),orderItemController.getOrderItemByOrderId)
